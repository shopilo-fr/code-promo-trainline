#!/usr/bin/env python3
"""
Recuperation des codes promo Trainline FR depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/trainline.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/trainline.fr"
STORE_NAME = "Trainline FR"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Trainline FR depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-trainline)"
    }
    try:
